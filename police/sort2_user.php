            ...
            <h2>
                <?php
                    if(isset($_POST['filter2'])){
                        ...
                        $name_query=mysql_query("select * from qualification where qualification='$qualification'")or die(mysql_error());
                ...
                <tbody>
                    <?php
                        ...
                        <?php
                            ...
                            $emp_query=mysql_query("select * from employee where qualification='$qualification'");
