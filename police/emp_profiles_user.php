                    ...
                    <?php $emp_query=mysql_query("select * from trafficpoliceofficer where FullName='$fullname'");
                        ...
                        <tr class="del<?php echo $id ?>">
                           ...
                           <td align="center" width="200">      
                               ...
                               <a class="btn btn-success"  id="p<?php echo $id; ?>" data-content="Click here to Edit Accident Details" rel="popover" data-original-title="Edit?"  href="edit_emp.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
