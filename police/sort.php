            ...
            <h2>
                <?php
                    if(isset($_POST['filter'])){
                        ...
                        $name_query=mysql_query("SELECT DISTINCT AccidentID from trafficpoliceofficer where FullName='$fullname' AND AccidentID='$sort'")or die(mysql_error());
                        $query_row=mysql_fetch_array($name_query);

                        echo $query_row['AccidentID']." ".'Accident Record';
        ...
        <div class="demo_jui">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
                ...
                <tbody>
                    ...
                    <?php $emp_query=mysql_query("SELECT * from trafficpoliceofficer where FullName='$fullname' AND AccidentID = '$sort' AND AccidentID = '$sort'");
