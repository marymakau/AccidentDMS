            ...
            <h2>
                <?php
                    if(isset($_POST['filter1'])){
                        ...
                        $name_query=mysql_query("select * from position where position='$position'")or die(mysql_error());
                ...
                <tbody>
                    <?php
                        ...
                        <?php
                            ...
                            $emp_query=mysql_query("select * from employee where Position='$position'");
