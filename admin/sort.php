            ...
            <h2>
                <?php
                    if(isset($_POST['filter'])){
                        ...
                        $name_query=mysql_query("SELECT * from user WHERE User_Type='$sort' ORDER BY UserName ASC")or die(mysql_error());
                        $query_row=mysql_fetch_array($name_query);

                        echo $query_row['User_Type']." ".'User Record';
...
<form method="post">
            ...
            <button name="filter" class="btn btn-success"><i class="icon-filter icon-large"></i>&nbsp;Sort</button></p>
        </form>
    <br>
                ...
                <tbody>
                    <?php
                        ...
                        <?php
                            ...
                            $emp_query=mysql_query("SELECT * from user WHERE User_Type='$sort' ORDER BY UserName ASC");
                            while($row=mysql_fetch_array($emp_query)){ $id=$row['User_id']; ?>
