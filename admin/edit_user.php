            ...
            <div class="hero-unit">
                <div class="hero-body-add-user">                 
                    <form class="form-horizontal" method="post">
                        <?php
                            $get_id=$_GET['id'];
                            $query_user=mysql_query("select * from user where User_id='$get_id'")or die(mysql_error());
                            $row=mysql_fetch_array($query_user);
                            $query_user1=mysql_query("SELECT DISTINCT User_Type from user where User_Type!='$row[User_Type]'")or die(mysql_error());
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="span2" name="type">
                                     ...
                                     <?php
                                     while($row1=mysql_fetch_array($query_user1)){ $type=$row1['User_Type'];echo "<option>$type</option>";} ?>
