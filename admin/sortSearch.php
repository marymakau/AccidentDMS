                ...
                <?php
                    if(isset($_POST['filter'])){
                       $search= $_SESSION['search'];
                        ...
                        $name_query=mysql_query("SELECT * from user WHERE User_Type='$sort' AND UserName like '%$search%' ORDER BY UserName ASC")or die(mysql_error());
                ...
                <tbody>
                    <?php
                        ...
                        <?php
                            ...
                            $emp_query=mysql_query("SELECT * from user WHERE User_Type='$sort' AND UserName like '%$search%' ORDER BY UserName ASC");
