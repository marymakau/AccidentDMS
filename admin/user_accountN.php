...
<body>
    ...
    <div id="element" class="hero-body">
        ...
        <div class="pull-right">  
            ...
            <ul>
                <li><a href="user_account.php" id="color_white">Police</a></li>

                <li  class="active"><a href="user_accountN.php" id="color_white">Non-Police</a></li>
            </ul>
            ...
            <div class="demo_jui">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
                    ...
                    <tbody>
                        ...
                        <?php $user_query=mysql_query("SELECT * from user WHERE User_Type !='police' ORDER BY UserName ASC");
